...
function rankingGet() {
    ...
    for (i in ranking) { //só mostra na div (remover no projeto oficial)
        ...
        element += '<div class="card blue-grey darken-1"><div class="card-content white-text row"><span class="card-title col s9 m4 nome">' + (parseInt(i) + 1) + ". " + ranking[i].name + '</span><span class="card-action col s2 m5 offset-m1 right"><a class="rankElem large-only">Ver Dados</a><a class="btn-floating ' + btn + ' waves-effect waves-light red hide-on-large-only"><i class="material-icons">add</i></a></span><span class="col s5 m2 pontuacao">' + ranking[i].pontuacao + ' pts' + '</span></div></div></div>';
        ...
        if(i<5) {
            element2 += '<div class="card blue-grey darken-1"><div class="card-content white-text row"><span class="card-title col s8 nome">' + (parseInt(i) + 1) + ". " + ranking[i].name + '</span><span class="card-action col s3"><a class="btn-floating btn waves-effect waves-light red"><i class="material-icons">add</i></a></span></div></div></div>';
